...
<?php echo get_sidebar() ?>
		...
		<div id="content" class="content" style="min-height:800px">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="active">Search Engine Settings</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Search Engine Settings <small>Administration Control Panel</small></h1>
			<!-- end page-header -->
			    ...
			    <div class="col-md-8">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">SEO Details</h4>
                        </div>
                        <div class="panel-body panel-form">
                            <form class="form-horizontal form-bordered" method="post" data-parsley-validate="true" name="demo-form">
								<div class="form-group">
									<label class="control-label col-md-4 col-sm-4" for="googleanalytics">Google Analytics Tracking Code:</label>
									<div class="col-md-6 col-sm-6">
                                        <textarea class="form-control" name="google_analytics_code" placeholder="Paste in your Google Analytics code here, this will be copied to all pages of your website" rows="3">
                                        	<?php echo $builderengine->get_option("google_analytics_code");?>
                                        </textarea>
									</div>
								</div>
