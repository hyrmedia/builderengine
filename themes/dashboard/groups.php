...
<ol class="breadcrumb pull-right">
    <li><a href="/admin">Home</a></li>
	 <li><a href="#">User</a></li>
	  <li class="active">Show Groups</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Show / Edit User Groups <small>Administration Control Panel</small></h1>
<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
                <!-- begin col-8 -->
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            <div class="btn-group pull-right">
                                <a <?php echo href('admin', 'user/edit_group/'.$group->id)?> class="btn btn-success btn-xs">Edit Group</a>
