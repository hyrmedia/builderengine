...
<ol class="breadcrumb pull-right">
    <li><a href="/admin">Home</a></li>
	 <li><a href="#">Settings</a></li>
	  <li class="active">Show Modules</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Edit / Show Modules and Apps <small>Administration Control Panel</small></h1>
<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
                <!-- begin col-8 -->
			       ...
			       <!-- begin panel -->
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Modules / Apps Details</h4>
                        </div>
                                ...
                                <tbody>
                                	<?php foreach($modules as $module):?>
	                                    <tr>
											...
											<td>
												<?php if($module->id != 4 && $module->id != 7 && $module->id != 8 && $module->id != 9):?>
												<div class="btn-group-vertical">
													<a href="/admin/modules/edit/<?php echo $module->id?>" class="btn btn-sm btn-success" style="margin-bottom:2px;"><i class="fa fa-edit"></i> Edit</a>
												</div>
												<div class="btn-group-vertical">
													<a href="/admin/modules/delete/<?php echo $module->id?>" class="btn btn-sm btn-inverse"><i class="fa fa-remove"></i> Delete</a>
												</div>
												<?php endif;?>
											</td>
	                                    </tr>
