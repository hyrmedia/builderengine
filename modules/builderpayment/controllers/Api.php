<?php
	class Api extends Module_Controller
	{
		...
		public function send_confirmation_email($order)
		{
			if($order->user_id == 0)
				return;
			...
			$message = $this->load->view('invoice/invoice.php', $data, true);
			...
			mail($user->email, "invoice", $message, $headers);
		}
		public function getAvailableGateways()
		{
			$gateways = array("paypal", 'cod', 'realex', 'stripe', 'authorize');
