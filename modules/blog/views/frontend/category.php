						...
						<li class="masonry-item">
							<div class="item">
								...
								<div class="item-title">
								    ...
								    <a href="#" class="label label-default light"><i>Post by:</i> <?=$user->username;?></a> <br/>
					         ...
					         ?>														
									<a href="/blog/post/<?=$post->slug?>#comments" class="scrollTo label label-default light"><i class="fa fa-comment-o"></i><?=$num_comments?> <?=$pluralizer?></a>
									<span class="label label-default light"><?=date('d.M.Y - h:i',$post->time_created)?></span> 
