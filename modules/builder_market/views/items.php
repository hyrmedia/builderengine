...
$(document).ready(function (){
    ...
    $('.install-button').click(function (){
        ...
        $(this).html('Installed');
                    ...
                    <?php else:?>
                    <?php $response->products = (array)$response->products;?>
                        <?php foreach($response->products as $product):?>
                            ...
                            <!-- Modal -->
                            <div id="product-<?=$product->id?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
