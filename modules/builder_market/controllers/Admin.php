...
### Temporary -> fake blocks ###############################################
		public function blocks()
		{

		   $products[0]=array(
                     'name'=>'Builder Engine Block 1',
					 'id'=>1,
					 'image'=>'/blocks/block_thumbnail.png',
					 'screenshots'=>array(0=>'/blocks/block_thumbnail.png'),
					 'publisher'=>'BuilderEngine LTD',	
				     'description'=>' <p>Lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor sit amet Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet </p>',
					 'type'=>'block',
					 'version'=>'1.2',
					 'price'=>'3.99',
			);
	       $products[1]=array(
                  'id'=>2,
                  'name'=>'Builder Engine Block 2','id'=>'2',
                  'image'=>'/blocks/block_thumbnail.png',
				 'screenshots'=>array(0=>'/blocks/block_thumbnail.png'),
			     'publisher'=>'BuilderEngine LTD',
			     'description'=>' <p>Lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor sit amet Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet </p>',										
		   ...
		   $products[1]=(object)$products[1];
           $response =array('status'=>'success','products'=>$products);
